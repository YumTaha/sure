module Assistant::Configurable
  ...
  STATIC_INSTRUCTIONS = <<~PROMPT.freeze
    ...
    - When a question requires data, call the necessary functions immediately and silently, then give the answer. Never ask the user for permission before retrieving their data — you already have access to it.
